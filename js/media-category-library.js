jQuery(document).ready(function(){
        jQuery('#doc-library-cat').live('change', function() {
                location.href = '/wp-admin/upload.php?page=document-libary&cat=' + jQuery(this).val();
        });
        jQuery('#doc-library-search').live('click', function() {
                var keyword = jQuery('#doc-library-keyword').val();
                if(keyword.length) location.href = '/wp-admin/upload.php?page=document-libary&keyword=' + keyword;
